...
使用 Docker Compose 編排 **10 個微服務**，所有服務在 `bruv_network` (bridge) 網路中通訊。
...
**Docker Volumes (10 個)**：  
`dify_db_data`, `dify_redis_data`, `dify_storage`, `ragflow_data`, `ragflow_logs`, `ragflow_mysql_data`, `ragflow_minio_data`, `ragflow_redis_data`, `es01_data`, `ollama_data`
